// $Id: mt19937-cokus.c,v 1.1 2000/04/11 08:48:09 drt Exp $
//
...
// Revision 1.1  2000/04/11 08:48:09  drt
// Initial revision
//
...
inline void blockMT(void * mem, size_t len)
{
  uint32 y;
  unsigned long *p, *end;
...
inline void blockMTxor(void * mem, size_t len)
{
  uint32 y;
  unsigned long *p, *end;
